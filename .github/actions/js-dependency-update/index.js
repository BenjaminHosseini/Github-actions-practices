...
async function run() {
  ...
  if (!validateDirectoryName({ dirName: workingDir})) {
    core.setFailed('Invalid working directory name. Branch names should include only characters, numbers, hyphens, underscores, and forward slashes.');
    return;
  }
  ...
  logger.debug(`Setting updates-availabe output to ${updatesAvailable}`);
